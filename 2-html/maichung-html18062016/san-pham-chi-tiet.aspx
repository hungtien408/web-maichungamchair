<%@ Page Title="" Language="C#" MasterPageFile="~/site-product.master" AutoEventWireup="true" CodeFile="san-pham-chi-tiet.aspx.cs" Inherits="san_pham_chi_tiet" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphSite" Runat="Server">
            <a href="san-pham.aspx">Sản phẩm</a>/<span>Sản Phẩm Chi Tiết</span>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="wrapper-details">
        ...
        <div class="details-content">
            <h4 class="product-name">Ghế văn phòng Ultrices</h4>
            <div class="product-code">NHH 08481</div>
             <div class="product-price">
                Giá bán: <strong>70.000<u>đ</u></strong>
            </div>
            <div class="desription">
                <ul class="list-info">
                    <li><strong>Thương hiệu:</strong>   Manufacturer</li>                    <li><strong>Lượt xem (View):</strong>   595</li>
                </ul>
                <p style="font-size: 17px;"><strong>Liên hệ trực tiếp để có giá tốt nhất</strong><br />                <strong style="color: #f00;">Hotline:</strong> <span style="color: #f00; font-size: 24px; font-style: italic;">094 456 9394</span></p>                <p>Hoặc Email: <a style="color: #000; font-style: italic;" href="mailto:sales@maichung.vn"><strong>sales@maichung.vn</strong></a></p>
            </div>
        </div>
        <div class="clr"></div>
    </div>
    <div class="wrapper-text">
    <h4 class="title text-uppercase">Mô tả sản phẩm</h4>
        <p>Ghế xoay, lưng ghế bọc vải nỉ hoặc da ngoại nhập, nệm dày.<br />        Ghế nhân viên lưng ngang<br />        Lưng ghế văn phòng bọc vải nỉ hoặc da<br />        Ghế văn phòng có nệm ngồi bọc Mousse từ 50 ly trở lên và được thiết kế nhỏ gọn phù hợp cho nhân viên văn phòng.<br />        Người ngồi có thể thay đổi độ cao ghế văn phòng dễ dàng, bằng cách nhấc nhẹ cần gạt bên tay phải.<br />        Chân ghế văn phòng được ép tự nhựa pp đen, có bánh xe để người sử dụng có thể di chuyển linh hoạt.<br />        Ghế văn phòng có thể ráp thêm tay, hoặc thay đổi phụ kiện ghế, tùy sở thích của bạn.</p>
        <p><strong>Chất liệu:</strong><br />        Vải nỉ hoặc da<br />        Nệm mousse <br />        Chân nhựa pp đen </p>
        <p><strong>Màu sắc:</strong><br />        Có thể đặt theo yêu cầu</p>
        <p><strong>Xuất xứ:</strong><br />        Chính hãng    </p>
    </div>
            <div class="head head-lineb">
                <h4 class="title text-uppercase">sản phẩm tương tự</h4>
                <div class="control-pager">
                    <a href="#" id="slidePrevo" class="fa fa-angle-left"></a>
                    <a href="#" id="slideNexto" class="fa fa-angle-right"></a>
                </div>
            </div>
            <div class="wrapper-in">
                    ...
                    <div class="slider-tree">
                        <div class="slide ">
                            <div class="product-box text-center">
                                <a href="san-pham-chi-tiet.aspx" class="product-img fullbox-img contain-img"><img class="hideo" src="assets/images/product-img-1.jpg" alt=""/> <span class="icona-plus"><span></span></span></a>
